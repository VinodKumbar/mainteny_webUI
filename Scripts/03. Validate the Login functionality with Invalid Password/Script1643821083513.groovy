...
WebUI.setText(findTestObject('Object Repository/Login Page/Page_Mainteny - Service Manager Portal/input_Enter your password_password'), 
    GlobalVariable.Invalid_Password)
...
WebUI.comment('to give demo on capture screenshot when test case get fail, delibrtely failing test step')

WebUI.verifyElementText(findTestObject('Login Page/Page_Mainteny - Service Manager Portal/div_Bad username or password'), 
    'captured failed test step screenshot')
